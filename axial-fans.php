                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        <div class="OurProductDetailsContent">
                                            <div class="aboutSecTitle">
                                                ...
                                                <div class="desc">
                                                    <p>Smoke spill fans from Marut Air—one of India’s leading axial fan manufacturers—are core components of smoke exhaust systems in commercial buildings, malls, hospitals, parking structures, and other large facilities. Installed at strategic ramp and shaft openings, they rapidly extract smoke and discharge it outdoors to enhance occupant safety during emergencies.</p>
                                                    <p>Our direct-driven Axial Flow Fans deliver high performance for general ventilation and smoke control. With wheel diameters from 315 to 1600 mm and field-adjustable blade pitch, they can be tuned to match exact system resistance and flow requirements.</p>
                                                    <p>Designed for both indoor and outdoor use, they accommodate ducted and non-ducted installations. Heavy-gauge casings (galvanized or mild steel as specified) ensure robustness and long service life.</p>
                                                    <p>Engineered for energy efficiency and low noise, Marut Air axial fans provide dependable airflow with reduced operating costs.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <div class="workContent">
                                            <div class="aboutSecTitle mb-5">
                                                ...
                                                <ul>
                                                    <li><b><i class="fa-regular fa-chevrons-right"></i></b> Dual purpose: daily ventilation and emergency smoke extraction; aerodynamic, adjustable blades for maximum efficiency.</li>
                                                    <li><b><i class="fa-regular fa-chevrons-right"></i></b> Motors: IP55, insulation Class H for smoke extract duty.</li>
                                                    <li><b><i class="fa-regular fa-chevrons-right"></i></b> Motors: IP55, insulation Class F for CO-exhaust duty, per EN 60034-5 / IEC 85.</li>
                                                    <li><b><i class="fa-regular fa-chevrons-right"></i></b> Casing options: galvanized steel or mild steel (as required).</li>
                                                    <li><b><i class="fa-regular fa-chevrons-right"></i></b> Compliance: EN 12101-3 (300 °C for 120 minutes / 2 hours).</li>
                                                    <li><b><i class="fa-regular fa-chevrons-right"></i></b> Sizes: 315 to 1600 mm wheel diameter.</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
