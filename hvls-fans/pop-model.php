<div class="sticklist">
    ...
    <ul>
      ...
      <li class="none-li inquiery-icon  imgnone">
        <a href="tel:919327935588" class="click1">
          <span class="icon1"> <i class="fa-solid fa-phone"></i></span> <span class="btn-text"> Call</span>
        </a>
      </li>
      <li class="whataspp-icon none-li imgnone">
        <a onclick="gtag('event', 'send', { 'event_category': 'click on whatsapp', 'event_action': 'Mobile', 'event_label': '919327935588' });" href="https://api.whatsapp.com/send?phone=919327935588&amp;text=Hello Team Marut Air, I was going through your Website, Please connect me for product discussion." target="_blank">
...
<select class="form-control" name="products">
  ...
  <div class="footer-box" style="display: none;">
    ...
    <div class="book-app" style="background:#000;" id="req-apnmt2">
      <a class="nav_up" href="tel:919327935588" style="color:#FFF; font-size:12px;font-weight:600;"><i class="fa-solid fa-phone" style="margin-right: 5px;"></i> Call</a>
    </div>
     
    <div class="book-app" style="background: #2db640;">
    <a onclick="gtag('event', 'send', { 'event_category': 'click on whatsapp', 'event_action': 'Mobile', 'event_label': '+919327935588' });" href="https://api.whatsapp.com/send?phone=919327935588&amp;text=Hello Team Marut Air, I was going through your Website, Please connect me for product discussion." target="_blank" style="color:#FFF; font-size:12px;font-weight:600;"><i class="fab fa-whatsapp" style="margin-right: 5px;"></i> Whatsapp</a>
  </div>
