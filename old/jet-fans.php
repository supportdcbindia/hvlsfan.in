                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        <div class="OurProductDetailsContent">
                                            <div class="aboutSecTitle">
                                                ...
                                                <div class="desc">
                                                    <p>Jet Fans are a pollution control solution that helps induce air to a common exhaust point through directed airflow. They have been globally accepted as a cost-effective alternative to traditional ducted parking garage ventilation for years.
                                                    </p>
                                                    <p>Jet Fans do not require ductwork. This saves money, provides a cleaner look with fewer conflicts, lowers height requirements, lower construction cost, and allows for easier maintenance.
                                                    </p>
                                                    <p>For Jet Fans in India, consider Marut Air, a leading manufacturer of Jet Fans.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-12 mt-40">
                                        <div class="OurProductDetailsContent">
                                            <div class="aboutSecTitle">
                                                ...
                                                <div class="desc">
                                                    <p>Elevate your indoor comfort with Marut Air’s cutting-edge Jet Fans. As a leading Jet Fans Manufacturer in India, we’re committed to delivering innovative solutions that optimize airflow and enhance your living or working environment. Contact us today to learn more about our products and services.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <div class="workContent">
                                            <div class="aboutSecTitle mb-5">
                                                ...
                                                <ul>
                                                    <li><b><i class="fa-regular fa-chevrons-right"></i></b> Dual Use: For daily ventilation and smoke extraction in case of fire (300 °C/120 min.)</li>
                                                    <li><b><i class="fa-regular fa-chevrons-right"></i></b>Symmetrical Aero-Dynamic blades for maximum thrust with low sound level</li>
                                                    <li><b><i class="fa-regular fa-chevrons-right"></i></b>Motors IP55 insulation class H (smoke extract); Motors IP55 insulation class F (CO-exhaust), according to EN 60034-5/IEC 85</li>
                                                    <li><b><i class="fa-regular fa-chevrons-right"></i></b>Casing manufactured from galvanized steel </li>
                                                    <li><b><i class="fa-regular fa-chevrons-right"></i></b>Conforming to EN 12101-3 (300 °C for 120 mins / 2 hrs) </li>
                                                    <li><b><i class="fa-regular fa-chevrons-right"></i></b>Fan size 315, 355, 400 diameter</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
